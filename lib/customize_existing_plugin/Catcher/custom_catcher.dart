...
class CustomCatcher with ReportModeAction {
  ...
  static CustomCatcher _instance;
  ...
  _reportError(dynamic error, dynamic stackTrace) async {
    ...
    if (reportMode is PageReportMode || reportMode is DialogReportMode|| reportMode is CustomDialogReportMode) {
      if (_isContextValid()) {
